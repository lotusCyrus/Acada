	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div >
				<form class="login100-form validate-form" method="post" action="register.php" >
					...
					<div class="wrap-input100 validate-input" data-validate="pls input User name">
                  ...
                  <i class="fa fa-graduation-cap" aria-hidden="true"></i>
					...
					<div class="wrap-input100 validate-input" data-validate="Kindly input matric number">
                      <input type="number" class="input100"  placeholder="Your current level"
                        name="level" required>
					...
					<div class="wrap-input100 validate-input" data-validate="Kindly input matric number">
					       ...
					       <select name="course" class="input100" aria-label="Default select example">
      ...
      while($r=mysqli_fetch_array($coursecodes, MYSQLI_ASSOC))
      {
       ...
       ?>
	          	...
	          	<div class="wrap-input100 validate-input" data-validate="Kindly input your dedired field">

						<input class="input100" type="number" name="field" placeholder="Desired field">
					...
					<div class="wrap-input100 validate-input" data-validate = "Create your suitable password">
