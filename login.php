...
<div class="jumbotron">
    ...
    <form id="loginForm" method="post" action="validation.php" class="needs-validation">
    <h5 class="font-weight-bold text-uppercase mb-4">
    Already a member? sign-in to your Dashboard
    </h5>
    <div class="form-group">
    <input type="number" class="form-control"  placeholder="Your Matric Number"
    ...
    <div class="form-group">
    <input type="password" class="form-control" id="num" placeholder="Your Admin Password"
    name="password" required> 
    </div>
    
    
    <button type="submit" class="btn btn-success">Log in</button> 
    <button onclick="register()" type="submit" class="btn btn-success">Register</button>
    </form>
    
    
        
  <form id="regForm" method="post" action="register.php" class="needs-validation">
   ...
   <div class="form-group">
   <input type="number" class="form-control"  placeholder="Your current level"
   name="level" required>
   </div>
   ...
   <div class="form-group">
      ...
      $sql="SELECT* FROM courselist";
        $coursecodes= mysqli_query($con, $sql);
      while($r=mysqli_fetch_array($coursecodes, MYSQLI_ASSOC))
      {
        echo "
   ...
   <div class="form-group">
   <input type="text" class="form-control"  placeholder="Desired Project Management Field "
   name="field" required>
   </div>
    ...
    <div class="row" >
      ...
      <div class="col-md-2 col-lg-2 mx-auto my-md-4 my-0 mt-4 mb-1">
        ...
        <ul class="list-unstyled" style="color:white;">
          ...
          <li>
            <p>
              <a href="http://localhost:8080/100%20level/materials.php#">Academia</a>
            </p>
          </li>
        </ul>
